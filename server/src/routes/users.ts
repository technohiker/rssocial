...
userRouter.get("/:username/news", ensureCorrectUser, async function (
  req,
  res,
  next
) {
...
userRouter.get("/:username/feeds", ensureCorrectUser, async function (
  req,
  res,
  next
) {
 ...
 */
userRouter.get("/:username", ensureCorrectUser, async function (
  req,
  res,
  next
) {
...
userRouter.get("/:username/metrics", ensureCorrectUser, async function (
  req,
  res,
  next
) {
